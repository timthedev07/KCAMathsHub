...
export const PageDisplay: FC<Props> = ({ questions, initialParams }) => {
  ...
  return (
    <>
      ...
      <div className="z-50 fixed bottom-4 right-[50%] left-[50%] md:left-auto md:right-4 transform -translate-x-1/2 md:translate-x-0 md:right-4 md:bottom-4 w-10/12 lg:w-60 h-16 bg-[#121212] border border-slate-400/20 rounded-xl">
