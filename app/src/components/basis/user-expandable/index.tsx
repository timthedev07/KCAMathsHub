      ...
      <div className="fixed right-[4%] top-20 w-[250px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 pt-5">
        <div className="flex flex-col items-center pb-10">
          ...
          <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">
            {user.username.length > 20 ? "Star Kolya" : user.username}
          </h5>
          ...
          <div className="flex mt-4 md:mt-6">
            <button
              type="button"
              className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ml-3"
            >
