...
const TermsConditions: NextPage = () => {
  return (
    <>
      ...
      <p>Welcome to KCAMathsHub!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of KCAMathsHub&apos;s Website, located at
        <Link href="https://kcamathshub.vercel.app">
      ...
      <p>
        ...
        conditions. Do not continue to use KCAMathsHub if you do not agree to
      ...
      <p>
        ...
        prevailing law of es. Any use of the above terminology or other words in
      ...
      <p>
        We employ the use of cookies. By accessing KCAMathsHub, you agreed to
        use cookies in agreement with the KCAMathsHub&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, KCAMathsHub and/or its licensors own the
        intellectual property rights for all material on KCAMathsHub. All
        intellectual property rights are reserved. You may access this from
        KCAMathsHub for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from KCAMathsHub</li>
        <li>Sell, rent or sub-license material from KCAMathsHub</li>
        <li>Reproduce, duplicate or copy material from KCAMathsHub</li>
        <li>Redistribute content from KCAMathsHub</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        KCAMathsHub does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of KCAMathsHub,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, KCAMathsHub shall not be
      ...
      <p>
        KCAMathsHub reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant KCAMathsHub a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of KCAMathsHub; and (d) the link
      ...
      <p>
        ...
        e-mail to KCAMathsHub. Please include your name, your organization name,
      ...
      <p>
        No use of KCAMathsHub&apos;s logo or other artwork will be allowed for
