...
const PrivacyPoliciesPage: NextPage = () => {
  return (
    <>
      ...
      <p>
        At KCAMathsHub, accessible from{" "}
        ...
        and recorded by KCAMathsHub and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in KCAMathsHub. This policy is not applicable to
      ...
      <p>
        KCAMathsHub follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of KCAMathsHub.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on KCAMathsHub, which are sent
      ...
      <p>
        Note that KCAMathsHub has no access to or control over these cookies
      ...
      <p>
        KCAMathsHub&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        KCAMathsHub does not knowingly collect any Personal Identifiable
